...
Nuestros datos se llaman `swiss` y son del paquete `{datasets}`, así que lo primero que debemos hacer es instalar el paquete (en caso de tenerlo, con `install.packages("datasets")`), después **llamar a ese paquete** (tenemos el libro comprado y lo sacamos de la estantería) con `library(datasets)` y escribir el nombre del conjunto de datos para mostrarlo.
