...
* [**script10.R**](https://github.com/dadosdelaplace/courses-ECI-2022/blob/main/scripts/script10.R): estructuras if-else.  Ver en <https://github.com/dadosdelaplace/courses-ECI-2022/blob/main/scripts/script10.R>
...
Para poder manejarnos con soltura con dichos datos es importante que conozcamos como se usan las <mark>**expresiones de control más típicas**</mark>. Una expresión de control será un <mark>**conjunto de órdenes**</mark> que nos permiten decidir por donde queremos que avance nuestro programa: ¿qué hacemos si sucede A? ¿Y si sucede B?
...
Una de las estructuras de control más famosas de cualquier lenguaje de programación: <mark>**SI las condiciones impuestas se cumplen (`TRUE`)**</mark>, ejecuta las órdenes que tengamos dentro del `if {}`. Definamos por ejemplo una variable sencilla, las edades de 8 personas.
