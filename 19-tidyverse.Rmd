...
<details>
  ...
  Podemos aprovechar para poner en práctica nuestros conocimientos, y crear una **función** que nos diga las películas en las que aparece cada personaje (con su nombre).
