...
:::: {.blackbox data-latex=""}* \@ref(funciones) [Funciones](#funciones)


Scripts usados:

* [**script09.R**](https://github.com/dadosdelaplace/courses-ECI-2022/blob/main/scripts/script09.R): importar datos.  Ver en <https://github.com/dadosdelaplace/courses-ECI-2022/blob/main/scripts/script09.R>
::::
