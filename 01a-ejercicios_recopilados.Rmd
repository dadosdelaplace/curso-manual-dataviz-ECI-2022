...
* [**script21.R**](https://github.com/dadosdelaplace/courses-ECI-2022/blob/main/scripts/script21.R): profundizando tidyverse.  Ver en <https://github.com/dadosdelaplace/courses-ECI-2022/blob/main/scripts/script21.>
...
## Visualizando datos: incursión a ggplot2 {-}

:::: {.blackbox data-latex=""}

Scripts usados:

* [**script22.R**](https://github.com/dadosdelaplace/courses-ECI-2022/blob/main/scripts/script22.R): incursión a ggplot2.  Ver en <https://github.com/dadosdelaplace/courses-ECI-2022/blob/main/scripts/script22.>
