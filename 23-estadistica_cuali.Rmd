...
Una buena definición de estadística puede ser la encontrada en [**wikipedia**](https://es.wikipedia.org/wiki/Estad%C3%ADstica#:~:text=La%20estad%C3%ADstica%20(la%20forma%20femenina,aleatorio%20que%20los%20genera%20siguiendo): 
...
No solo ha cambiado la clase de la variable sino que ahora, debajo del valor guardado, nos aparece la frase `Levels: grave leve sano`: son las **modalidades o niveles** de nuestra cualitativa. Imagina que ese día en el hospital no tuviésemos a <mark>**nadie en estado grave**</makr>: aunque ese día nuestra variable no tome dicho valor, el estado `grave` es un nivel permitido que podríamos tener, así que aunque lo eliminemos, por ser un factor, el nivel permanece (no lo tenemos ahora pero es un nivel permitido).-
