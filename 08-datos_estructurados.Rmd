...
Ya sabemos un poco la gramática y ortografía de nuestro lenguaje, y algunas de las funcionalidades básicas de nuestro «Word». Vamos a aprender cómo escribir la mejor trama para la novela: hablemos por fin de <mark>**datos**</mark>.
...
Para practicar vamos a definir otro ejemplo, con las **edades, teléfonos y códigos postales** de una serie de individuos (fíjate que he metido adrede datos ausentes, ya que a veces no tendremos datos de algunas personas).
